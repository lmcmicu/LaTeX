...
% Uncomment this statement, and then copy the file qcircuit_custom_commands.tex from ArticleTemplates/
% to the current working directory to support working with quantum circuit diagrams
